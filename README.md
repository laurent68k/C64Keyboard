...
During debuging the USB serial is used with Arduino Studio, while we will use the TxD/RxD TTL line for interfacing any microcontroller-based project.

My goal : Interfacing this keyboard/Arduino to a 68B50 UART. 
